...
%\greencomment{Stan: Suggest formatting the recommendations more clearly and thinking about whether there are others that would be good to get out there.  How about recommending that the ET project and the LIGO Lab each send someone to KAGRA for an extended stay to learn about cryogenic suspensions and to help commission KAGRA?  Probably too late to have much impact, but wouldn't that have been a good way to get some real hands-on experience with the issues surrounding cryogenic suspensions into LIGO and ET?  }
