...
\greencomment{Dave: Again, reference science case LF goals here.} 
...
More specifically, 
% in the current scenario for 3G, 
the ET design aims to reduce the low frequency sensitivity cutoff ca.\,2\,Hz. 
%actual value is 1.8Hz in the ET design study. Page 194
...
\magentacomment{hal: I have got the impression that SUS and SAS get confused here. We should distinguish between Seismic Isolation systems also called Seismic attenuation systems (SAS) and the suspension systems for the mirrors (SUS). Going to lower frequencies the SUS typically get longer, while the SAS, relying more on active suppression for the low frequencies do not have to.}
...
% with actual noise cancellation 
