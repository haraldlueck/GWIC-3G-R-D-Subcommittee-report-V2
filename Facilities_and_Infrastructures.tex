\chapterimage{Figures1_3/Virgotube1_3.jpg} % Chapter heading image
...
\label{sec:Fac_Inf}
\vspace{1cm}
%\ac{3G} facility conceptual designs must be mature well before construction, as the infrastructure will dominate both cost and construction of new observatories
...
%are aspects which can impact the infrastructure cost and stability. These aspects are particularly relevant for underground infrastructure such as the one planned for hosting the \ac{ET}detector.
%Optimizing the site facility and infrastructure's influence on  detector performance is only one aspect of the \ac{RaD} work required.  
...
% \magentacomment{hal: part of the improvement w.r.t. a\ac{LIGO} comes from length also in the \ac{ET} case cos (60 deg) x 10\,km = ca. 2 x 4\,km and the number of detectors = three, which makes it somewhat equivalent to a 13\,km detector, within the limits of comparability. I agree: it is still less than 40\,km} 
...
%\magentacomment{Beverly: are there other fields or areas requiring largish UHV? Harald: I do not think so.}
...
%\section{Timelines}
%3G Infrastructure and facilities construction will start roughly 5 years before the installation of detector hardware and ten years before observations. Thus, the timescales for study and design are short and critical. For site preparations for \ac{ET} and \ac{CE} to start as early as $\sim$\,2025, the respective \ac{RaD} and detailed technical studies have to reach conclusions imminently. The responsible international collaborations and their working groups should be focused on this goal.