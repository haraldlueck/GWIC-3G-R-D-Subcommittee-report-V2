...
\subsection{3G initial/future}\magentacomment{hal: derive required action items (Josh: Subscale demos, current gen equipment noise surveys)}
...
Optimal vacuum tube diameters, taking into account scattered light issues, vacuum conductance, costs etc. need to be derived as soon as possible, as the diameters of the vacuum tubes influence the tunnel size and therefore costs.

\section{Pathways and required facilities}

\magentacomment{Josh: The coatings workshop recommended test facilities for material/coating outgassing rates. hal: Do you mean vacuum- workshop?}
