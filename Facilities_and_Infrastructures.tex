...
\label{sec:Fac_Inf}
\vspace{1cm}
%3G facility conceptual designs must be mature well before construction, as the infrastructure will dominate both cost and construction of new observatories
...
\item We recommend that every effort  is made to minimize costs by careful choice of site and methods for facility and infrastructure construction.
...
\item Collaboration with high energy particle physics community and with industry on facilities and infrastructure research, design, and testing  will be particularly valuable to leverage experience in building large accelerator facilities and vacuum systems.
\end{itemize}
