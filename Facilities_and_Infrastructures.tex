...
Advances in tunnel boring machines and in surface road and pipeline excavation have been seen to drastically reduce the cost per kilometer of public works structures over recent decades\magentacomment{hal: citation needed, e.g. www.boringcompany.com. This technique only works in soft soil afaik.}. Directed research into applying these modern methods to reduce the cost and collateral impact of projects such as ET and CE should be explored as a high priority. 
...
\subsection{3G initial/future}\magentacomment{hal: derive required action items}
