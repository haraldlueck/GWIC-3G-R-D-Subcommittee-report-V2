...
%Taking full advantage of the best quantum noise reduction schemes available for  \ac{3G}   will require additional flexibility and space to be built into the planned infrastructure that allow for enhancements and upgrades to the initial  \ac{3G}   detectors. 
...
%Both 2G and  \ac{3G}   detectors are based on long baseline L- or triangle-shaped interferometers with additional cavities.
%% The fundamental shape of  \ac{3G}   and 2G detectors will be based on long baseline L-shaped interferometers with additional cavities. 
%It is expected that some quantum noise reduction schemes developed for  \ac{3G}   can be installed in current facilities and should be considered for further upgrades to 2G observatories. This will mitigate some risks associated with  \ac{3G}  . However, only  \ac{3G}   facilities will be able to fully support the potential of advanced quantum noise reduction schemes, and quantum noise  \ac{RaD}   for  \ac{3G}   is not a subset of ongoing efforts but demands a new dedicated approach, requiring funding and person power. Challenging  \ac{RaD}   for  \ac{3G}   observatories has the potential to attract additional early career scientists who will be able to also support the needs of the detectors today. 
...
%dependent squeezing. 
%\item Benefit for  \ac{3G}   programme for 2G: Potentially improved sensitivity and faster commissioning plus risk reduction.
%\end{itemize}