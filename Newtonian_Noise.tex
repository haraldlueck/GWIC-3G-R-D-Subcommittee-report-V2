...
%The chapter has a nice description of the state of research, and what the issues are, but then it just sort of ends. The Outlook section makes some milk-toast recommendations ("...significant R\&D into the above open questions should continue through the 3G era such that the NN of the chosen site and infrastructure can be reduced as much as possible.") and then ends.  I suggest you rewrite the Outlook section with a set of specific recommendations.  Make them specific and stronger, e.g., include NN criteria in any site evaluation, organize regular meetings of the various groups working on this topic, explore getting computer time on the analysis clusters when they are not being fully used, etc.  Make recommendations to both the researchers doing the work and the funders that support them.   }
